...
def process_image(image_path, query):
    try:
        ...
        llama_11b_response = make_api_request("meta-llama/llama-4-scout-17b-16e-instruct", messages)
        llama_90b_response = make_api_request("meta-llama/llama-4-scout-17b-16e-instruct", messages)
